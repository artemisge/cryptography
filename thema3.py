...
#print("len of coincidencies", len(coincidencies))
...
# print(textFreq)
textFreqPrc = copy.deepcopy(textFreq)
for i in range(len(textFreqPrc)):
    textFreqPrc[i] /= sum(textFreq)
# print(textFreqPrc)
abZip = zip(alphabetFreq, alphabet)
tst = [x for y, x in sorted(zip(alphabetFreq, alphabet), reverse=True)]
# print(tst)
# that part finishes
...
#print(ziplettersYsorted)
#print(zipletterssorted)
#print(tst)
